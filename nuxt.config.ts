...
// Shorter description for link previews (Open Graph / X), kept under 125 characters
const OG_DESCRIPTION = 'Commercial carpet, tile, wood & resilient flooring across Northeast Ohio. Family owned and union installed since 1965.'
