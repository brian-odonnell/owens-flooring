		...
		<div class="about-inner">
			...
			<div class="about-media">
				...
				<div class="about-badge">
					...
					<span class="badge-text">1965</span>
				</div>
			</div>
			...
			<div class="about-text">
				...
				<a href="#contact" class="btn-primary about-cta">Work With Us</a>
			</div>
		</div>
...
const values = [
	...
	{ title: 'Family Owned Since 1965', desc: 'Three generations of the same family, still doing business the same way — with integrity.' },
]

const team = [
	{ name: 'Matthew O\'Donnell', role: 'President' },
