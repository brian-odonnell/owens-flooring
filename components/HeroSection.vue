	...
	<section id="hero" class="hero">
		...
		<div class="hero-content">
			<div class="hero-inner">
				<p class="section-label hero-eyebrow">Northeast Ohio's Flooring Specialists Since 1965</p>
				...
				<p class="hero-sub">
					We install resilient flooring, tile, and more for commercial spaces across Northeast Ohio. On time. On budget. Done&nbsp;right.
				</p>
				...
				<div class="hero-stats">
					...
					<div class="stat">
						<span class="stat-num">Est. 1965</span>
