  ...
  <section id="contact" class="contact">
    <div class="contact-inner">
      ...
      <div class="contact-info">
        ...
        <h2 class="section-title contact-title">Request a<br>Free Estimate</h2>
        <p class="contact-sub">
        ...
        <div class="contact-details">
          <a href="tel:+14402691112" class="contact-detail-item">
            <div class="detail-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13 19.79 19.79 0 0 1 1.61 4.35 2 2 0 0 1 3.6 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 9.91a16 16 0 0 0 6.16 6.16l.91-.91a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
            </div>
            <div>
          ...
          <a href="mailto:contact@owensflooring.net" class="contact-detail-item">
            <div class="detail-icon">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
            </div>
            <div>
          ...
          <div class="contact-detail-item">
            ...
            <div>
              ...
              <p class="detail-value">Mon–Fri 9am-5pm · Sat 10am-2pm</p>
            </div>
          </div>
        </div>
      </div>
        ...
        >
          <div class="form-row">
            <div class="form-field">
              ...
              <input id="name" v-model="form.name" name="name" type="text" placeholder="Jane Smith" required />
            </div>
            <div class="form-field">
              <label for="company">Company</label>
              <input id="company" v-model="form.company" name="company" type="text" placeholder="Acme Corp" />
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="form-field">
              ...
              <input id="email" v-model="form.email" name="email" type="email" placeholder="jane@acme.com" required />
            </div>
            <div class="form-field">
              <label for="phone">Phone</label>
              <input id="phone" v-model="form.phone" name="phone" type="tel" placeholder="(555) 000-0000" />
            </div>
          </div>
          ...
          <div class="form-field">
            ...
            <textarea id="message" v-model="form.message" name="message" rows="4" placeholder="Describe your space, timeline, and any other details…" required></textarea>
          </div>
          ...
          <p class="form-note">We respond within 1 business day. No spam, ever.</p>
        </form>
      </div>
    </div>
  </section>
